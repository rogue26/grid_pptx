...
class Table(_GridPanel):
    df: Union[pd.DataFrame, pd.Series]
    minimize_height: bool = True
    header: bool = True
    first_col: bool = False
    fontsize: int = 14
    style: str = 'medium_style_3_accent_1'
